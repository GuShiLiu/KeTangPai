<template>
  <div>
    ...
    <div style="margin-left: 70px; height: 200px; width: 91%; margin-top: 80px;
      ...
      <span style="color: white; font-size: 50px;position: relative;left: -560px;top: -20px;font-family: serif;">{{name}}</span>
    </div>
    <div style="margin-left: 70px; margin-right: 54px;">
      <el-menu router="/coursePage" :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect"
        ...
        <el-menu-item index=workList style="margin-left: 35px;">
          全部作业
        </el-menu-item>
        ...
        <el-menu-item index="topicTeacher" style="margin-left: 25px;">
          话题
        </el-menu-item>
        <el-menu-item index=scoreList style="margin-left: 25px;">
